...
//         <img src={assets.main_banner_bg_sm} alt="banner" className='w-full md:hidden md:block'/>
...
//         <div class='flex items-center mt-6 font-small'>
//          <Link to={"/products"} className='group flex items-center gap-2 px-7 md:px-9 py-3 bg-black hover:bg-white hover:text-black transition rounded text-white cursor-pointer'><p className='font-small text-white'>Explore</p>
